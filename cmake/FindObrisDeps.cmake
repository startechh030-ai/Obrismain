...
if(EXISTS "${FILAMENT_DIR}")
    ...
    if(FILAMENT_SO)
        ...
        # filamat
        file(GLOB FILAMAT_SO "${FILAMENT_DIR}/lib/${ANDROID_ABI}/libfilamat-jni.so")
        if(FILAMAT_SO)
            add_library(filament::filamat UNKNOWN IMPORTED GLOBAL)
            set_target_properties(filament::filamat PROPERTIES IMPORTED_LOCATION "${FILAMAT_SO}")
            message(STATUS "Obris: ✅ filamat found")
        endif()
    else()
